<template>
  <div>
      ...
      -->
        ...
        -->
          <div class="absolute left-full top-0 flex w-16 justify-center pt-5">
            <button @click="isMobileOpen = false" type="button" class="-m-2.5 p-2.5">
    ...
    <div class="lg:pl-72">
      ...
      >
        <button @click="isMobileOpen = true" type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden">
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          ...
          <form class="grid flex-1 grid-cols-1" action="#" method="GET">
            <input
              ...
              aria-label="Search"
             v-model="searchQuery"
              class="col-start-1 row-start-1 block h-full w-full bg-white pl-8 text-base text-gray-900 outline-none placeholder:text-gray-400 sm:text-sm/6"
              placeholder="Search"
            />
            <svg
              class="pointer-events-none col-start-1 row-start-1 h-5 w-5 self-center text-gray-400"
              viewBox="0 0 20 20"
              fill="currentColor"
              aria-hidden="true"
              data-slot="icon"
            ...
            <div class="relative">
              ...
              >
                ...
                <!-- <img
                  ...
                  alt=""
                /> -->
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5.52 19c.64-2.2 1.84-3 3.22-3h6.52c1.38 0 2.58.8 3.22 3"/><circle cx="12" cy="10" r="3"/><circle cx="12" cy="12" r="10"/></svg>
