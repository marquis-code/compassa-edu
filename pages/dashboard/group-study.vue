<template>
    ...
    <div class="flex flex-row h-full w-full overflow-x-hidden">
      <div class="flex flex-col py-8 pl-6 pr-2 w-80 bg-white flex-shrink-0">
        <div class="flex flex-row items-center justify-center h-12 w-full">
          ...
          <div class="ml-2 font-bold text-xl">Group Study</div>
        </div>
          <div class="mt-4 flex justify-center gap-x-3 items-cemter">
            <input v-model="searchQuery" type="text" placeholder="Search groups or start a new chat"
              class="w-full px-4 py-3 border-[0.5px] rounded-md bg-gray-50 tetx-sm  focus:outline-none focus:border-indigo-500" />

            <button @click="toggleFilterModal" class="text-gray-600 border-[0.5px] rounded-lg px-2 hover:text-gray-800">
              <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" y1="21" x2="4" y2="14"></line><line x1="4" y1="10" x2="4" y2="3"></line><line x1="12" y1="21" x2="12" y2="12"></line><line x1="12" y1="8" x2="12" y2="3"></line><line x1="20" y1="21" x2="20" y2="16"></line><line x1="20" y1="12" x2="20" y2="3"></line><line x1="1" y1="14" x2="7" y2="14"></line><line x1="9" y1="8" x2="15" y2="8"></line><line x1="17" y1="16" x2="23" y2="16"></line></svg>
            </button>
          </div>
        ...
        <div class="flex flex-col mt-5">
          <div class="flex flex-row items-center justify-between text-xs">
            ...
            <span
              class="flex items-center justify-center font-semibold bg-gray-300 h-6 w-6 rounded-full">{{ userGroupsList?.length }}</span>
          </div>
          ...
          <div class="flex flex-col space-y-3 mt-4 -mx-2  overflow-y-auto">
            <button v-for="(item, idx) in filteredGroups" :key="idx"
              :class="{ 'bg-gray-200': item._id === route.query.group }"
              class="flex flex-row items-center py-3 rounded-md pl-3 hover:bg-gray-100"
      ...
      <div class="flex flex-col flex-auto h-full p-6">
        <div class="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-gray-100 h-full p-4">
          ...
          <div class="flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
            ...
            <input type="file" ref="fileInput" accept="image/*, video/*, audio/*, .pdf, .doc" class="hidden"
  ...
  <FilterModal v-if="filterModalOpen" :groups="allGroups" @close="toggleFilterModal" @joinGroup="joinGroup"
  ...
  <CoreFullScreenLoader :visible="fetchingGroupMessages" class="z-50"
  text="Please wait while we fetch group messages" /> 
  <AddGroupModal v-if="addGroupModalOpen" :processing="processing" @close="toggleAddGroupModal" @submit="handleAddGroup" />
  ...
  <ConfirmationModal :visible="showJoinGroupConfirmationModal" title="Join Group"
    ...
    <template #icon>
      <svg class="w-12 h-12" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
