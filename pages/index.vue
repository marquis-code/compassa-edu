  ...
  <main>
    ...
    <div class="relative isolate overflow-hidden">
      ...
      <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div class="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
          <img class="h-11 rounded-full" src="@/assets/img/logo.jpeg" alt="Your Company">
          <div class="mt-24 sm:mt-32 lg:mt-16">
            <a href="#" class="inline-flex space-x-6">
              <span class="rounded-full bg-indigo-500/10 px-3 py-1 text-sm/6 font-semibold text-indigo-400 ring-1 ring-inset ring-indigo-500/20">What's new</span>
        ...
        <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
          <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
            <img src="@/assets/img/study.jpg" alt="App screenshot" width="2432" height="1442" class="w-[76rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10">
          </div>
        </div>
      </div>
    </div>
        ...
        <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
          <div class="flex flex-col">
            ...
            <dd class="mt-1 flex flex-auto flex-col text-base/7 text-gray-300">
              <p class="flex-auto">Access lecture notes, past questions, and textbooks in one platform organized by course and department.</p>
              <p class="mt-6">
          ...
          <div class="flex flex-col">
            ...
            <dd class="mt-1 flex flex-auto flex-col text-base/7 text-gray-300">
              <p class="flex-auto">Work with peers through group study tools, shared annotations, and knowledge exchange features.</p>
              <p class="mt-6">
                <a href="#" class="text-sm/6 font-semibold text-indigo-400">Learn more <span aria-hidden="true">→</span></a>
              </p>
            </dd>
          ...
          <div class="flex flex-col">
            ...
            <dd class="mt-1 flex flex-auto flex-col text-base/7 text-gray-300">
              <p class="flex-auto">Quickly locate relevant materials with advanced AI-powered search and recommendation systems.</p>
              <p class="mt-6">
                <a href="#" class="text-sm/6 font-semibold text-indigo-400">Learn more <span aria-hidden="true">→</span></a>
              </p>
            </dd>
      ...
      <div class="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
        <dl class="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base/7 text-gray-300 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
          <div class="relative pl-9">
            ...
            <dd class="inline">Access course-specific lecture notes, textbooks, and other essential academic resources in one place.</dd>
          </div>
          <div class="relative pl-9">
            <dt class="inline font-semibold text-white">
              <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
            ...
            <dd class="inline"> Quickly find relevant materials using advanced AI recommendations tailored to your academic needs.</dd>
          </div>
          <div class="relative pl-9">
            <dt class="inline font-semibold text-white">
              <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
            ...
            <dd class="inline">Work with peers, share annotations, and participate in group study sessions for enhanced learning.</dd>
          </div>
          <div class="relative pl-9">
            <dt class="inline font-semibold text-white">
              <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
            ...
            <dd class="inline"> Download materials to access them offline, ensuring uninterrupted study even without internet.</dd>
          </div>
          <div class="relative pl-9">
            <dt class="inline font-semibold text-white">
              <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
            ...
            <dd class="inline">Earn points and recognition for contributing valuable resources to the community.</dd>
          </div>
          <div class="relative pl-9">
            <dt class="inline font-semibold text-white">
              <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
            ...
            <dd class="inline">Inclusive design with audio-text support and multilingual options to cater to all students.</dd>
          </div>
        </dl>
      </div>
    </div>
    ...
    <div class="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl text-center">
        ...
        <p class="mx-auto mt-6 max-w-xl text-lg/8 text-gray-300">Incididunt sint fugiat pariatur cupidatat consectetur sit cillum anim id veniam aliqua proident excepteur commodo do ea.</p>
  ...
  <div class="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
    ...
    <div class="mt-20">
      <dl class="space-y-16 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-16 sm:space-y-0 lg:grid-cols-3 lg:gap-x-10">
        <div>
          <dt class="text-base/7 font-semibold text-white">How do I sign up?</dt>
          <dd class="mt-2 text-base/7 text-gray-300">Simply click the "Register Now" button on the homepage and follow the prompts to create your account.</dd>
        </div>
        ...
        <div>
          <dt class="text-base/7 font-semibold text-white">Can I contribute content?</dt>
          <dd class="mt-2 text-base/7 text-gray-300"> Absolutely! Earn rewards by contributing valuable academic resources to the platform.</dd>
        </div>
